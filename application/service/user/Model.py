...
class UserModel(TortoiseBaseModel):
    ...
    avatar: str = TextField(null=True,
                            ...
                            description="头像URL")
    age: int = IntField(default=18, max_length=3, null=True, description="年龄")
    ...
    intro: str = CharField(default="简短介绍一下自己吧~", max_length=250, null=True, description="个人简介")
    occupation: str = CharField(default="未知", max_length=20, null=True, description="职业")
    address: str = CharField(default="未知", max_length=50, null=True, description="地址")
    ...
    is_employee: bool = BooleanField(null=True, default=False, description="是否员工账号")
